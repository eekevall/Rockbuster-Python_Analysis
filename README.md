...
After loading Rockbuster’s data into the PostgreSQL relational database management system (RDBMS) SQL was used to analyze the data, address the key objectives and answer the key business questions.
